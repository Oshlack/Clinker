...
def createAnnotationFiles(fusions, st_genes, genomic_coordinates, annotation_folder):
    ...
    for fusion in fusions.list:
        ...
        try:
            ...
            print "Chromosome " + fusion.chromosome_1 + " not in reference... continuing."
            continue
        ...
        try:
            ...
            print "Chromosome " + fusion.chromosome_2 + " not in reference... continuing."
            continue
...
def createFusionList(fusion_results, pos, gene_list_location, st_genes, header, delimiter):
    ...
    for line in fusion_results:
        ...
        fusion, duplicates, found, not_found = mapSupertranscript(gene_1, gene_2, chr_1, chr_2, 
                                                duplicates, found, not_found, 
                                                total, st_genes)
